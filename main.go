...
// 	prompt := fmt.Sprintf("Infer the intention of the user and write as a good formatted one pragraph input message for an AI based on following input: %s", input)
